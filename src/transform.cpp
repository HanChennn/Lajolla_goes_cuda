...
// __host__ __device__ Matrix4x4 translate(const Vector3 &delta) {
...
// __host__ __device__ Matrix4x4 scale(const Vector3 &s) {
...
// __host__ __device__ Matrix4x4 rotate(Real angle, const Vector3 &axis) {
...
// __host__ __device__ Matrix4x4 look_at(const Vector3 &pos, const Vector3 &look, const Vector3 &up) {
//     Matrix4x4 m;
...
// __host__ __device__ Matrix4x4 perspective(Real fov) {
...
// __host__ __device__ Vector3 xform_point(const Matrix4x4 &xform, const Vector3 &pt) {
//     Vector4 tpt(
...
// __host__ __device__ Vector3 xform_vector(const Matrix4x4 &xform, const Vector3 &vec) {
...
// __host__ __device__ Vector3 xform_normal(const Matrix4x4 &inv_xform, const Vector3 &n) {
